...
\begin{itemize}
	...
	\end{enumerate}
	\item Fueling in H-mode is problematic due to transport barrier? NBI fueling?
	\item H-mode density limit\parencite{Bernert:2015ppcf} must be avoided
\end{itemize}
...
\begin{frame}{Future and Miscellaneous}
	\begin{itemize}
		\item piggybag on Quescient H-mode shots
