...
\usetheme[conference=23rd SOLDiv ITPA,venue=Naka, date=25/10/2016, titleprogressbar, logo=RFX-logo]{Eurof}
...
\centering{N. Vianello$^{1,2}$, C. Tsui$^{3,2}$, C. Theiler$^2$,
  S. Allan$^4$, J. Boedo$^3$, B. Labit$^2$, H. Reimerdes$^2$, K. Verhaegh$^{5}$,
  W. Vijvers$^6$, N. Walkden$^4$,  S. Costea$^7$, J. Kovacic$^{8}$, C. Ionita$^{7}$, 
V. Naulin$^9$, A. H. Nielsen$^9$, J. J. Rasmussen$^9$, B. Schneider$^7$, 
R. Schrittwieser$^7$, M. Spolaore$^1$, 
D. Carralero$^{10}$, J. Madsen$^9$, the TCV Team and the EUROfusion MST1 Team}

\centering{\footnotesize
\textit{$^1$Consorzio
RFX,  Padova, Italy, $^2$Swiss Plasma Center (SPC), EPFL Lausanne, Switzerland,
  $^3$UCSD,  La Jolla, USA, $^4$CCFE,  Culham UK, $^5$York Plasma Institute, University of York, York, UK,
$^6$FOM Institute DIFFER, The Netherlands, $^7$Institute for Ion Physics and Applied Physics,
Innsbruck,  Austria, $^{8}$Jozef Stefan Institute, Ljubljana, $^9$DTU,  Copenhagen, Denmark, $^{10}$Max-Plank-Institut fur Plasmaphysik, Garching, Germany}}
\end{frame}
