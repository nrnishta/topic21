...
\begin{columns}
  \begin{column}{0.65\textwidth}
    ...
    \centering{\includegraphics<4>[width=\textwidth]{../../Experiments/AUG/analysis/pdfbox/LambdaDivVsTime}}
    \centering{\includegraphics<5>[width=\textwidth]{../../Experiments/AUG/analysis/pdfbox/EvolutionEdgeProfileConstantq95}}
  \end{column}
