...
\begin{frame}{Neutral behavior investigation on AUG}
  ...
  \only<2>{
    \centering{\includegraphics[width=10cm]{../../Experiments/AUG/analysis/pdfbox/Dalpha/Agostini_Fig2.pdf}}
  ...
  \only<3>{
    \centering{\includegraphics[width=10cm]{../../Experiments/AUG/analysis/pdfbox/Dalpha/Agostini_Fig3.pdf}}
...
Radiation starts moving along the separatrix with different patterns between the two radiation
  ...
  \only<4>{
    \centering{\includegraphics[width=10cm]{../../Experiments/AUG/analysis/pdfbox/Dalpha/Agostini_Fig4.pdf}}
