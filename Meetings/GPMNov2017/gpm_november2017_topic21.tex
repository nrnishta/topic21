...
\Fontvi
  ...
  \begin{column}{0.65\textwidth}
    ...
    \centering{\includegraphics<6>[width=\textwidth]{../../Experiments/TCV/analysis/pdfbox/IpConstantq95_samedensity}}
    \centering{\includegraphics<7>[width=\textwidth]{../../Experiments/TCV/analysis/pdfbox/CompareTargetProfilesConstantQ95}}
    \centering{\includegraphics<8>[width=\textwidth]{../../Experiments/AUG/analysis/pdfbox/BlobSizeCurrentScanConstantQ95}}
    \centering{\includegraphics<9>[width=\textwidth]{../../Experiments/TCV/analysis/pdfbox/LambdaSizeIpScanConstantQ95}}
...
\Fontvi
  ...
  \begin{column}{0.65\textwidth}
    ...
    \centering{\includegraphics<6>[width=\textwidth]{../../Experiments/TCV/analysis/pdfbox/IpConstantBt_samedensity}}
    \centering{\includegraphics<7>[width=\textwidth]{../../Experiments/TCV/analysis/pdfbox/CompareTargetProfilesConstantBt}}
    \centering{\includegraphics<8>[width=\textwidth]{../../Experiments/AUG/analysis/pdfbox/BlobSizeCurrentScanConstantBT}}
    \centering{\includegraphics<9>[width=\textwidth]{../../Experiments/TCV/analysis/pdfbox/LambdaSizeIpScanConstantBt}}
    ...
    \begin{itemize}
      ...
      \item<5|only@5> AUG: At comparable edge density Upstream profiles are
        ...
        lower current. \alert{We have flattening of the upstream
          profiles only when $\Lambda_{div}$ is well above one on all
          the profile}
      \item<6|only@6> TCV: This tendency is substantially confirmed at
        TCV where
        profiles  
      \item<7|only@7> TCV: This is consistent with onset of detachment
        (at least in intermediate and lower current)
      \item<8|only@8> AUG: While the general observation of increasing
        blob size with $\Lambda_{div}$ is confirmed there are no
        differences between the current
      \item<9|only@9> TCV: confirm the observation of AUG. 
      \end{itemize}
    \end{column}
\end{columns}
\end{frame}
