...
\begin{frame}{Motivation and deliverables}
  ...
  \begin{itemize}
    \item \alert{Relation between downstream divertor conditions and
        ...
        conditions is element towards predictive capabilities. }
  \end{itemize}
  \onslide<2->{Deliverables listed during the call for manning of last December
\begin{enumerate}
...
\item \only<3>{\color{ta3chameleon}}Use the new HHF probe on AUG to study
