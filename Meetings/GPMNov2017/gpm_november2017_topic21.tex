...
\Fontvi
  ...
  \begin{column}{0.65\textwidth}
    ...
    \centering{\includegraphics<11>[width=\textwidth]{../../Experiments/TCV/analysis/pdfbox/LambdaSizeIpScanConstantQ95}}
...
\begin{columns}
  \begin{column}{0.65\textwidth}
    ...
    4\centering{\includegraphics<4>[height=0.9\textheight]{../../Experiments/AUG/analysis/pdfbox/Shot_34278_34281_InterELMprofiles}}
  \end{column}
  \begin{column}{0.35\textwidth}
    \begin{itemize}
      ...
      \item<3-> Without cryopumps evidence of stronger SOL profile
       ...
       \item<4> Inter-ELM resolved Li-Be profiles 
    \end{itemize}
  \end{column}
\end{columns}
\end{frame}
