...
\usetheme[conference=25th ITPA-DivSOL,venue=Chengdu, date=31/01/2018, titleprogressbar, logo=RFX-logo]{Eurof}
...
%\graphicspath{{/Users/nicola/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/}{../Experiments/}}
% for drawing
\usepackage{pgf}
\usepackage{tikz}
...
\begin{frame}{Current scan at constant B$_t$ in L-Mode plasma}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \includegraphics<1>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/EquilibriaIpScanConstantBt}
      ...
      \includegraphics<6>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/UpstreamTargetProfilesConstantBt}
      \includegraphics<7>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/ExampleShoulderAmplitude}
      ...
      \includegraphics<11>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/EfoldBlobAllColor}         
    \end{column}
    \begin{column}{0.4\textwidth}
      \begin{itemize}
        ...
        \item<3|only@3> TCV: Ohmic heating only. Similar neutral compression reached and
          ...
          330 kA
        \item<4|only@4> AUG: Divertor neutral density estimated starting
        ...
        \item<5|only@5> AUG: Neutrals behavior reconciled whenever
        ...
        \item<6|only@6> For both AUG and TCV flattening of normalized
          ...
          reached for larger values of divertor collisionality $\Lambda_{div}$
        ...
        \item<11|only@11> For both AUG and TCV density decay length
          $\lambda_n$ increases
...
\begin{frame}{Current scan at constant q$_{95}$}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \includegraphics<1>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/EquilibriaIpScanConstantQ95}
      ...
      \includegraphics<4>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/UpstreamTargetProfilesConstantQ95}
      % \includegraphics<5>[width=\textwidth]{../../Experiments/TCV/analysis/pdfbox/CompareTargetProfilesConstantQ95}
      \includegraphics<5>[width=\textwidth]{../../Experiments/AUG/analysis/pdfbox/AmplitudeVsLambdaIpConstantQ95}
      \includegraphics<6>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/EfoldVBlobAllColorConstantQ95}         
      \includegraphics<7>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/BlobLambdaAllColorConstantQ95}         
    \end{column}
    \begin{column}{0.4\textwidth}
      \begin{itemize}
        ...
        \item<4|only@4> For AUG upstream and target profiles still
          ...
          $\Lambda_{div}$}. For TCV no sign of upstream profile flattening \alert{even
            at very large values of $\Lambda_{div}$. No clear sign of detachment which is mandatory for
            upstream profile modication in TCV}
        % \item<5|only@5> TCV: This is due to the fact we did not reach
        %   divertor detachment which \alert{seems mandatory for
        %     upstream profile modification}  
        \item<5|only@5> AUG: Amplitude evolution as a function of $\Lambda_{div}$ 
          still reconcile the explored current scan
        \item<6|only@6> AUG exhibit consistently an increase of
          $\lambda_n$ with blob-size whereas for TCV the profile
          remains flat consistently with a small variation of
          $\delta_b$
        \item<7|only@7> And for TCV this is true even at high value of
...
\begin{frame}{H-Mode analysis on AUG}
  ...
  \centering{\includegraphics<4>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/EfoldSizeShots34276_34278}}
  \centering{\includegraphics<5>[width=\textwidth]{\string~/Documents/Fisica/Conferences/IAEA/iaea2018/pdfbox/EfoldSizeShots34276_34278_34281}}
  \end{column}
  \begin{column}{0.45\textwidth}
    \begin{itemize}
    \item<1|only@1> We perform a series of shots in H-Mode with 6.5 MW 
      ...
      \begin{itemize}
        ...
        \item<1|only@1> \textcolor{colorC}{\#34281 where we increase
            ...
            pressure as \# 34276}
      \end{itemize}
    \item<1|only@1> Keeping the same fueling with the cryopump in
      operation clearly
      reduce the pressure in the the sub-divertor area, plasma
      detachment is not reached and edge density is constant despite
      the increase fueling. Degraded H-mode reached later without the cryopump
    ...
    \item<3|only@3> The profiles for shot \# 34278 with the cryopump
      and lower fueling remains steeper in all the three timing
      window and the plasma is still attached. Interestingly for shot \#
      34281 with the cryopumps and higher fueling target profiles are broader
    \item<4|only@4> Without the cryopumps, we reached flatter
         profiles and relatively large inter-ELM resolved blob-size of
         the same size as L-Mode. This
         indicates strong neutral pressure effects in determining
         upstream profiles. \alert{Preliminary work. Further analysis
           needed to confirm the observed values.}
    \item<5|only@5> Increasing the fueling and correspondingly the
      ...
      \# 34276 without the cryopump. \alert{Preliminary work. Further analysis
           needed to confirm the observed values.}
      \end{itemize}
  \end{column}
\end{columns}
...
\begin{frame}{Conclusion}
  ...
  \begin{itemize}
    \item Current scan at constant B$_t$ and at constant q$_{95}$
      ...
      and TCV
    \item For the scan at constant B$_t$ nn both the machines shoulder
      appear earlier in density at lower
    ...
    \item H-Mode experiments performed on AUG where fueling and
      ...
      also in H-Mode with a more efficient shoulder formation with
      high neutral pressure (no cryopumps or very high fueling).
      \alert{Hints on the role of neutrals also in H-Mode}
  \end{itemize}
\end{frame}
