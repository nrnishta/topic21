...
\begin{frame}{Current scan at constant B$_t$}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      ...
      \includegraphics<4>[width=\textwidth]{NeutralsVsGreenwaldConstantBt}
    ...
    \begin{column}{0.4\textwidth}
      \begin{itemize}
        ...
        \item<4|only@4> Divertor neutral density estimated starting
          ...
          increase earlier in edge density at smaller current
        \item<5|only@5> Neutrals behavior reconciled whenever
          comparison considered as a function of Greenwald fractin  
